...
class CritiquesControllerTest < ActionController::TestCase
  ...
  test "should create critique" do
    assert_difference('Critique.count') do
      post :create, critique: { description: @critique.description, song: @critique.song, user_id: @critique.user_id }
    end
  ...
  test "should update critique" do
    patch :update, id: @critique, critique: { description: @critique.description, song: @critique.song, user_id: @critique.user_id }
    assert_redirected_to critique_path(assigns(:critique))
  end
